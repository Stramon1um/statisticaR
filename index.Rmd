...
Nel primo caso possiamo usare il comando **read.csv2**, il quale usa di default il formato numerico italiano, nel secondo caso possiamo usare il comando **read.csv2**:
...
Successivamente possiamo dare una breve occhiata al nostro dataset appena caricato da .csv. Il comando **head()** e **tail()** permettono, senza parametri aggiuntivi (come mostrato), di mostrare velocemente in R console rispettivamente la parte iniziale e finale di un dataset.
